      ...
      <div className="flex-1 overflow-y-auto p-6 lg:p-8 space-y-7">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5">
          ...
          <div className={`p-5 rounded-2xl border shadow-xs transition-colors flex flex-col justify-between ${
            ...
            <div className="my-3">
              <h3 className={`text-2xl font-extrabold tracking-tight ${isDark ? 'text-white' : 'text-slate-900'}`}>
                {totalCategories} <span className="text-xs font-normal text-slate-400">Classifications</span>
              </h3>
            </div>
            <p className="text-[10px] text-slate-400">Active catalog divisions</p>
          </div>
          ...
          <div className={`p-5 rounded-2xl border shadow-xs transition-colors flex flex-col justify-between ${
            ...
            <div className="my-3">
              <h3 className={`text-2xl font-extrabold tracking-tight ${isDark ? 'text-white' : 'text-slate-900'}`}>
                {totalCategorizedSkus} <span className="text-xs font-normal text-slate-400">Assigned SKUs</span>
              </h3>
            </div>
            <p className="text-[10px] text-slate-400">Mapped warehouse items</p>
          </div>
          ...
          <div className={`p-5 rounded-2xl border shadow-xs transition-colors flex flex-col justify-between ${
            ...
            <p className="text-[10px] text-slate-400">Combined catalog value</p>
          </div>
          ...
          <div className="p-5 rounded-2xl bg-[#00684a] text-white flex flex-col justify-between shadow-md shadow-[#00684a]/20">
            ...
            <div className="my-3">
              <h3 className="text-2xl font-extrabold tracking-tight truncate text-white">
                ...
                <div className="flex items-center gap-2 pt-2 border-t border-slate-100 dark:border-slate-800">
                  <button 
                    ...
                    className={`flex-1 py-2 px-3 rounded-xl text-xs font-bold border transition-colors flex items-center justify-center gap-1.5 cursor-pointer ${
                      isDark ? 'border-slate-800 bg-slate-800/70 hover:bg-slate-700 text-slate-300' : 'border-slate-200 bg-slate-100 hover:bg-slate-200 text-slate-700'
                    }`}
                  >
                ...
                categoryProducts.map(prod => (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h4 className={`text-xs font-extrabold ${isDark ? 'text-white' : 'text-slate-900'}`}>{prod.name}</h4>
                        <span className="text-[10px] text-slate-400 font-mono">{prod.sku || `SKU-#${prod.id}`}</span>
                      </div>
                    </div>

                    <div className="text-right">
                      <p className="text-xs font-black text-[#00684a] dark:text-emerald-400">₱{parseFloat(prod.price || 0).toFixed(2)}</p>
                      <span className="text-[10px] font-bold text-slate-400">{prod.quantity} Units Available</span>
                    </div>
                  </div>
                ))
              ) : (
