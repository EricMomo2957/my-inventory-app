...
export default function Register() {
  ...
  return (
    <div className={`min-h-screen flex flex-col justify-between p-6 font-sans transition-colors duration-500 relative overflow-hidden ${
      ...
      {/* Center Auth Area */}
      <div className="w-full max-w-xl mx-auto my-auto relative z-10 flex flex-col items-center">
        ...
        <div className={`w-full p-8 sm:p-10 rounded-[2.5rem] border shadow-2xl backdrop-blur-xl relative transition-all duration-300 ${
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  placeholder="••••••••••••"
                  required
                  className={`w-full pl-11 pr-11 py-3 rounded-2xl border text-sm font-medium outline-none transition-all ${
                    isDarkMode 
                      ? 'bg-[#070c18] border-slate-800 text-white focus:border-[#00684a]' 
                      : 'bg-slate-50 border-slate-200 text-slate-900 focus:bg-white focus:border-[#00684a]'
                  }`}
            ...
            <button 
              type="submit" 
              disabled={isLoading}
              className="w-full mt-3 bg-[#00684a] hover:bg-[#00583e] text-white py-3.5 rounded-2xl font-black text-sm uppercase tracking-wider shadow-lg shadow-[#00684a]/25 transition-all cursor-pointer active:scale-98 disabled:opacity-50"
            >
