...
export default function ForgotPassword() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (data.success) {
        setMessage("Check your inbox! Reset instructions have been dispatched.");
      } else {
        setError(data.message || "No authorized account registered with that email.");
      }
    } catch { 
      setError("Failed to connect to the server. Please verify network connection.");
    } finally {
      setIsLoading(false);
    }
  };
        ...
        <div className={`w-full p-6 sm:p-8 rounded-3xl border shadow-2xl backdrop-blur-xl relative transition-all duration-300 ${
          ...
          <div className="text-center mb-4">
            ...
            <p className="text-xs font-medium text-slate-400 dark:text-slate-400 mt-0.5">
              Enter your registered staff email to receive recovery instructions.
            </p>
          </div>
          ...
          {message && (
            <div className="mb-4 p-3 bg-emerald-500/10 border border-emerald-500/30 rounded-xl text-[#00684a] dark:text-emerald-400 text-xs font-bold flex items-center gap-2">
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  placeholder="staff@mindstock.com"
                  required
