...
export default function ClerkDashboard() {
  ...
  try {
    // This matches your backend PUT /api/products/:id route
    await axios.put(`http://localhost:3000/api/products/${selectedProduct.id}`, {
      name: selectedProduct.name,
      quantity: newQuantity,
      adjustment: adjValue,
      clerk_name: userData.full_name // From localStorage/State
    });
    ...
    alert("Could not update stock. Check backend console.");
  }
};
